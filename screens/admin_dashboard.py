...
class AdminDashboard(QWidget):
    ...
    def init_ui(self):
        ...
        analytics_label.setStyleSheet("font-size: 16px; font-weight: bold; color: #2c3e50;")
        ...
        """)
        analytics_frame.setMinimumHeight(800)  # Increased height to accommodate more charts
        analytics_layout = QGridLayout(analytics_frame)
        analytics_layout.setContentsMargins(20, 20, 20, 20)  # Add padding
        analytics_layout.setSpacing(20)  # Add spacing between charts
        
        # Sales chart
        self.sales_figure = Figure(figsize=(5, 4), dpi=100)
        self.sales_canvas = FigureCanvas(self.sales_figure)
        self.sales_canvas.setMinimumHeight(250)
        self.sales_canvas.setMinimumWidth(300)  # Set minimum width
        sales_frame = QFrame()  # Create a container frame
        sales_frame.setStyleSheet("background-color: white; border: 1px solid #e0e0e0; border-radius: 4px;")
        sales_layout = QVBoxLayout(sales_frame)
        sales_layout.addWidget(QLabel("Sales Trend"))
        ...
        self.product_canvas.setMinimumHeight(250)
        self.product_canvas.setMinimumWidth(300)  # Set minimum width
        product_frame = QFrame()  # Create a container frame
        product_frame.setStyleSheet("background-color: white; border: 1px solid #e0e0e0; border-radius: 4px;")
        product_layout = QVBoxLayout(product_frame)
        product_layout.addWidget(QLabel("Product Performance"))
        ...
        self.profit_canvas.setMinimumHeight(250)
        self.profit_canvas.setMinimumWidth(300)  # Set minimum width
        profit_frame = QFrame()  # Create a container frame
        profit_frame.setStyleSheet("background-color: white; border: 1px solid #e0e0e0; border-radius: 4px;")
        profit_layout = QVBoxLayout(profit_frame)
        profit_layout.addWidget(QLabel("Profit Analysis"))
        ...
        self.inventory_canvas.setMinimumHeight(250)
        self.inventory_canvas.setMinimumWidth(300)  # Set minimum width
        inventory_frame = QFrame()  # Create a container frame
        inventory_frame.setStyleSheet("background-color: white; border: 1px solid #e0e0e0; border-radius: 4px;")
        inventory_layout = QVBoxLayout(inventory_frame)
        inventory_layout.addWidget(QLabel("Inventory Status"))
        ...
        self.cost_canvas.setMinimumHeight(250)
        self.cost_canvas.setMinimumWidth(300)  # Set minimum width
        cost_frame = QFrame()  # Create a container frame
        cost_frame.setStyleSheet("background-color: white; border: 1px solid #e0e0e0; border-radius: 4px;")
        cost_layout = QVBoxLayout(cost_frame)
        cost_layout.addWidget(QLabel("Cost Analysis by Category"))
        ...
        self.margin_canvas.setMinimumHeight(250)
        self.margin_canvas.setMinimumWidth(300)  # Set minimum width
        margin_frame = QFrame()  # Create a container frame
        margin_frame.setStyleSheet("background-color: white; border: 1px solid #e0e0e0; border-radius: 4px;")
        margin_layout = QVBoxLayout(margin_frame)
        margin_layout.addWidget(QLabel("Profit Margin by Category"))
        ...
        low_stock_label.setStyleSheet("font-size: 16px; font-weight: bold; color: #2c3e50;")
        ...
        """)
        low_stock_frame.setMinimumHeight(250)  # Set minimum height
        ...
        self.low_stock_table.setMinimumHeight(150)  # Set minimum height
        ...
        non_selling_label.setStyleSheet("font-size: 16px; font-weight: bold; color: #2c3e50;")
        ...
        """)
        non_selling_frame.setMinimumHeight(250)  # Set minimum height
        ...
        self.non_selling_table.setMinimumHeight(150)  # Set minimum height
    ...
    def update_sales_chart(self, start_date, end_date):
        ...
        if not sales_data:
            ...
            if len(dates) > 10:
                step = len(dates) // 10
                ticks = [i for i in range(0, len(dates), step)]
                ax.set_xticks(ticks)
    ...
    def update_inventory_chart(self):
        ...
        if not products:
            ...
            ax.text(0.02, 0.95, f"Total Store: {total_store}", transform=ax.transAxes,
                   fontsize=10, fontweight='bold', bbox=dict(facecolor='white', alpha=0.8))
            ax.text(0.02, 0.88, f"Total Warehouse: {total_warehouse}", transform=ax.transAxes,
                   fontsize=10, fontweight='bold', bbox=dict(facecolor='white', alpha=0.8))
    ...
    def update_cost_analysis_chart(self, start_date, end_date):
        ...
        # Format y-axis to show full category names
